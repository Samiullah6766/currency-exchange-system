...
import { ownerExchangeTransaction } from "../../services/OwnerExchangeTransaction";
import { useNavigate } from "react-router-dom";
import { currencyLabel } from "../../services/dateUtils";

const OwnerExchangeTransaction = () => {
  ...
  const handleCreation = (e) => {
    ...
    ownerExchangeTransaction(data)
      .then((res) => {
        if (res.status === 200 || res.status === 201) {
          setInsufficientBalance(false);
          navigator("/owner-exchange-transactions");
        }
      })
      .catch((error) => {
        console.error(error);
        ...
        >
          ...
          <div className="card-header bg-white py-4">
            <div className="d-flex justify-content-between align-items-center">
              <div>
                <h3 className="mb-1 fw-bold text-dark">خرید و فروش دفتر</h3>
            ...
            <form onSubmit={handleCreation}>
              ...
              <div className="d-flex justify-content-end gap-2 mt-4">
                <button
                  type="button"
                  className="btn btn-outline-secondary px-4"
                  onClick={() => navigator("/owner-exchange-transactions")}
                >
                  لغو
                </button>
...
export default OwnerExchangeTransaction;
